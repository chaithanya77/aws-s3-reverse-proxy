...
func NewOptions() Options {
	...
	kingpin.Flag("allowed-endpoint", "allowed endpoint (Host header) to accept for incoming requests").Required().PlaceHolder("ecr.burritobowl.in:443").StringVar(&opts.AllowedSourceEndpoint)
